...
const Camera: FunctionComponent<IProps> = ({
  ...
  return (
    <div className="relative flex group">
      ...
      <div className="group-hover:h-[70px] absolute top-[0] left-[0] right-[0] h-[0] flex gap-[6px] text-[white] flex-col justify-center pl-[12px] overflow-hidden [transition:0.2s_height]">
        <p className="text-sm">{camera.userName}</p>
        <p className="text-xs text-slate-200">{camera.role}</p>
      </div>
      <div className="group-hover:h-[70px] absolute left-[0] right-[0] h-[0] bottom-[0] flex gap-[12px] items-center justify-center [transition:0.2s_height] overflow-hidden">
        <button
